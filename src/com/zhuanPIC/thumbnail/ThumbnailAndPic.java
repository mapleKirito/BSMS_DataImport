...
public class ThumbnailAndPic {
    ...
    * @return
    */
    public String proce1(String oldFile, int width, int height, float quality,String xin) {
        if (oldFile == null) {
            return null;
        }
        ...
        try {
            ...
            /*int new_w = (int) (((double) srcFile.getWidth(null)));
            int new_h = (int) (((double) srcFile.getHeight(null)));*/
            ...
            /** 压缩之后临时存放位置 */
            FileOutputStream out = new FileOutputStream(xin);
