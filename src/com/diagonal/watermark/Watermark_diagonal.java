 ...
 * @author Michael
 */ 
public class Watermark_diagonal { 
    /**
     * 给图片添加水印
    ...
    public static void markImageByIcon(String iconPath, String srcImgPath, 
        ...
        try { 
            ...
            if(fg.equalsIgnoreCase("one")){
            	g.drawImage(img, (srcWidth -IconWidth)/2, (srcHeight - IconHeight)/2, null);             	
            }else if(fg.equalsIgnoreCase("two")){
            	g.drawImage(img, (srcWidth -IconWidth)/2, srcHeight-((srcHeight - IconHeight)/2), null);  
            }
            /*else if(fg.equalsIgnoreCase("three")){
            	g.drawImage(img, srcWidth / 2-IconWidth/2, srcHeight-srcHeight/6, null);  
            }*/
